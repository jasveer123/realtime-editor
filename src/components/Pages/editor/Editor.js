        ...
        const init = async () => {
            ...
            socketRef.current.on(
                ...
                ({ clients, username, socketId }) => {
                    ...
                    console.log("thissssssssss", codeRef.current, socketId)
            ...
            <div className='aside'>
                ...
                <div className='div1'>
                    ...
                    <div className='Avatar'>
                        {Clients.map((client) => {
                            return (<Avatara username={client.username} key={client.socketId} />)
                        })}
                    </div>
                </div>
                <div className='asideinner'>
                    <button id="copy-btn" className='btn-editor' onClick={copytext}>Copy Room ID</button>
                    <br />
                    <br />
                    <button id="leave-btn" className='btn-editor' onClick={exitfunc}>Leave</button>
                </div>
